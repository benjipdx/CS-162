...
/*
	char userinput;
	cout << "Would you like to enter an event? (y/n)" <<endl;
	cin >> userinput;
	cin.ignore(100, '\n');
	if (toupper(userinput) == 'Y')
	{
		cout << "This section of the program is for entering events." <<endl;
	...
	{
		cout << "Would you like to enter a booth? (y/n)" <<endl;
		cin >> userinput;
		cin.ignore(100, '\n');
	
		if (toupper(userinput) == 'Y')
		{
			cout << "This section of the program is for entering booths." <<endl;
			for(int i =0; again() == true; ++i)
			{
				booth_input(booth[i]);
				write_booth_to_file(booth[i], i);
			}
		}
		...
		else if (toupper(userinput) == 'N')
		{
			...
			cout << "This section of the program is for searching for an existing booth." <<endl;
			//somthting about searching for a bototh
			//find()
		}
